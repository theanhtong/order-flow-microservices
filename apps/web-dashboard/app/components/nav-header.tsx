        ...
        <div className="flex items-center gap-3 font-mono text-xs">
          ...
          {isAuthenticated && user ? (
            <div className="flex items-center gap-2">
              <div className="flex items-center gap-2 w-full border border-slate-200 rounded-sm p-2">
                <Link href="/orders" className="flex flex-col w-full hover:opacity-80 transition cursor-pointer" title="View Orders">
                  <span className="text-slate-900 font-semibold truncate">{user.fullName}</span>
                ...
                <button
                  ...
                  className="p-1.5 text-slate-500 hover:text-red-600 hover:bg-slate-100 transition shrink-0"
                  title="Sign Out"
                >
